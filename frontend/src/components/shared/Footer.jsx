      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-8 md:mt-0">
            <Link to="https://facebook.com" className="transform hover:scale-110 transition-transform duration-300" aria-label="Facebook">
            ...
            <Link to="https://twitter.com" className="transform hover:scale-110 transition-transform duration-300" aria-label="Twitter">
              <svg className="w-8 h-8 text-gray-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link to="https://linkedin.com" className="transform hover:scale-110 transition-transform duration-300" aria-label="LinkedIn">
              <svg className="w-8 h-8 text-gray-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
